...
<#
.SYNOPSIS
This script installs Image Glass on a MCS/PVS master server/client or wherever you want.
...
$PackageName = "ImageGlass" 	 # [edit] enter the display name of the software (e.g. 'Arcobat Reader' or 'Microsoft Office')
