...
<#
.SYNOPSIS
This script installs FileZilla on a MCS/PVS master server/client or wherever you want.
...
try {
    Start-Process "$PSScriptRoot\$Product\FileZilla.exe" -ArgumentList '/S' -Wait
    } catch {
